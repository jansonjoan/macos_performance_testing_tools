...
-----------------
This zip archive contains two versions of GPU Caps Viewer:

- GPU_Caps_Viewer.exe is the regular version

- GPU_Caps_Viewer_v2.exe has the same features but custom widget colors 
  have been disabled.
